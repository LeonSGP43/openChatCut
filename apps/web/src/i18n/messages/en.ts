export const enMessages = {
	...
	assetsTabs: {
		...
		settings: "Settings",
		comingSoonTransitions: "Transitions view coming soon...",
		comingSoonFilters: "Filters view coming soon...",
		comingSoonAdjustment: "Adjustment view coming soon...",
	},
	mediaView: {
		title: "Assets",
		noActiveProject: "No active project",
		failedToProcessFiles: "Failed to process files",
		contextExportClips: "Export clips",
		...
		sortByLabel: "Sort by {sortBy} ({order})",
		sortName: "Name",
		sortType: "Type",
	...
	mediaDragOverlay: {
		...
		dropHint: "Drag and drop videos, photos, and audio files here",
	},
	propertiesPanel: {
	...
	captionsView: {
		...
		stepLoadingModel: "Loading model {progress}%",
		stepTranscribing: "Transcribing...",
		stepExtractingAudio: "Extracting audio...",
		stepPreparingAudio: "Preparing audio...",
		stepGeneratingCaptions: "Generating captions...",
	},
	aiView: {
		panelTitle: "AI",
		initial:
