...
function ContentSection({
	...
	return (
		<Section
			collapsible
			sectionKey={`text:${trackId}:${element.id}:content`}
			showTopBorder={false}
		>
			<SectionHeader>
...
function TypographySection({
	...
	return (
		<Section collapsible sectionKey={`text:${trackId}:${element.id}:typography`}>
			<SectionHeader>
...
function SpacingSection({
	...
	return (
		<Section
			collapsible
			sectionKey={`text:${trackId}:${element.id}:spacing`}
...
function BackgroundSection({
	...
	return (
		<Section
			...
			sectionKey={`text:${trackId}:${element.id}:background`}
		>
			<SectionHeader
				trailing={
					<Button
